...
class Am(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "AmTransmiter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AmTransmiter")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/pauly/Escritorio/Javier/Señales y sistemas/Lab3/acoustic.wav', True)
        ...
        self.audio_sink_0_0 = audio.sink(20000, '', True)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 480000, 0.5, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_max_xx_0, 0))
